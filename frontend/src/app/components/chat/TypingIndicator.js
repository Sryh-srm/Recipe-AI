...
export default function TypingIndicator() {
  return (
    ...
    >
      {/* AI Avatar */}
      <div className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-br from-[#7C3AED] to-[#8B5CF6] flex items-center justify-center shadow-lg shadow-[#7C3AED]/30 ai-avatar-pulse">
      ...
      {/* Bubble */}
      <div className="glass-card rounded-2xl rounded-bl-sm px-5 py-3.5 flex items-center gap-1.5 text-[#A855F7]">
